package cl.td.employeeservice.service.impl;
...
import cl.td.employeeservice.repository.EmployeeRepository;
import cl.td.employeeservice.service.APIClient;
...
//                .block();
    ...
    @Override
    public Integer getPortFromDepartment() {

        ResponseEntity<Integer> responseEntity = restTemplate.getForEntity("http://DEPARTMENT-SERVICE/api/departments/get-port-number",
         Integer.class);
